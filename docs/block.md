...
For detailed technical information about a block please visit [Blocks](https://xazab-docs.github.io/en/glossary/block) on the Xazab Wiki.
...
For more information about the specific properties of a block header please visit the [Block headers](https://xazab-docs.github.io/en/developer-reference#block-headers) page on the Xazab Developer Reference Wiki.
