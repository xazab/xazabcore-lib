...
bitcore.versionGuard = function(version) {
  if (version !== undefined) {
    var message = 'More than one instance of xazabcore-lib found. ' +
      'Please make sure that you are not mixing instances of classes of the different versions of xazabcore.';
    console.warn(message);
  }
};
bitcore.versionGuard(global._xazabcore);
global._xazabcore = bitcore.version;
